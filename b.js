...
graph.addEdge("c16", "c15", 1);
graph.addEdge("c4", "c13", 1);
graph.addEdge("c15", "c14", 1);
graph.addEdge("c15", "c25", 1);
graph.addEdge("c12", "c13", 1);
graph.addEdge("c11", "c12", 1);
graph.addEdge("c10", "c11", 1);
graph.addEdge("c17", "c25", 1);
graph.addEdge("c17", "c16", 1);
graph.addEdge("c9", "c10", 1);
graph.addEdge("c18", "c19", 1);
graph.addEdge("c21", "c18", 1);
graph.addEdge("c20", "c21", 1);
graph.addEdge("c20", "c19", 1);
graph.addEdge("c8", "c8", 1);
graph.addEdge("c9", "c10", 1);
graph.addEdge("c10", "c7", 1);
graph.addEdge("c5", "c6", 1);
graph.addEdge("c2", "c28", 1);
graph.addEdge("c2", "c27", 1);
graph.addEdge("c24", "c27", 1);
graph.addEdge("c23", "c24", 1);
graph.addEdge("c8", "c20", 1);
graph.addEdge("c20", "c22", 1);
graph.addEdge("c22", "c23", 1);
graph.addEdge("c23", "c6", 1);
graph.addEdge("c18", "c17", 1);
graph.addEdge("c7", "c8", 1);
graph.addEdge("c26", "c7", 1);
graph.addEdge("c3", "c26", 1);
